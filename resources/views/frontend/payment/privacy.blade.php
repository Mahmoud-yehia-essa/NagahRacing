...
<html>
  ...
  <body>
    ...
    <p>
      This privacy policy applies to the Nagah Racing - نجاح ريسنج app
      (hereby referred to as "Application") for mobile devices that was created
      by MAHMOUD YEHYA MOHAMED AWAD (hereby referred to as "Service Provider")
    ...
    <p>
      ...
      please contact them at mahmoudessa@gmail.com and they will respond in a
      reasonable time.
    </p>
    ...
    <div>
      ...
      <p>
        ...
        Service Provider (mahmoudessa@gmail.com) so that they will be able to
    ...
    <br />
    <p>This privacy policy is effective as of 2025-11-01</p>
    ...
    <p>
      ...
      via email at mahmoudessa@gmail.com.
    </p>
  </body>
</html>
