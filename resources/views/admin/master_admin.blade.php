...
<head>
    ...
    <style>
		...
		/* Brand Color (#971048) Global Overrides */
		.logo-text,
		.toggle-icon,
		.text-primary,
		...
		.sidebar-wrapper .metismenu a:focus,
		.sidebar-wrapper .metismenu a:hover {
			background-color: rgba(151, 16, 72, 0.08) !important;
		}

		.btn-primary {
			background-color: #971048 !important;
			border-color: #971048 !important;
		...
		.btn-primary:focus,
		.btn-primary:active {
			background-color: #7b0d3a !important;
			border-color: #7b0d3a !important;
			box-shadow: 0 0 0 0.2rem rgba(151, 16, 72, 0.25) !important;
		}
